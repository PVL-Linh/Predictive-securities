...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "app thống kê chỉnh sửa dữ liệu thị trường cổ phiếu"))
        self.logo_label_3.setText(_translate("MainWindow", "DATA APP"))
        self.home_btn_2.setText(_translate("MainWindow", "DU DOAN"))
        self.dashborad_btn_2.setText(_translate("MainWindow", "VE BIEU DO"))
        self.orders_btn_2.setText(_translate("MainWindow", "QUAN LY"))
